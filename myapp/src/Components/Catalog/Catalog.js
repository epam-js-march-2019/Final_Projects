...
render(){ 
    ...
    state = {
    items: [
    {name:'Чистка лица',price:"1000",description:'Механическая чистка лица производится на высшем уровне.'},
    {name:'Массаж лица',price:"500",description:'Профессиональный массаж длинною 30 мин.'},
    {name:'Пилинг',price:"600",description:'Кислотный пилинг. Кожа после него как у младенца.'},
